...
function createSortViewTemplate(currentSortType) {
  return (
    `<form class="trip-events__trip-sort  trip-sort" action="#" method="get">
            <div class="trip-sort__item  trip-sort__item ${currentSortType === SortType.DAY ? 'board__sort-item--active' : ''}">
              <input id="sort-day" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" data-sort-type="${SortType.DAY}" value="sort-day">
              <label class="trip-sort__btn" for="sort-day">Day</label>
            </div>

            <div class="trip-sort__item  trip-sort__item ${currentSortType === SortType.EVENT ? 'board__sort-item--active' : ''}">
            ...
            <div class="trip-sort__item  trip-sort__item ${currentSortType === SortType.TIME ? 'board__sort-item--active' : ''}">
            ...
            <div class="trip-sort__item  trip-sort__item ${currentSortType === SortType.PRICE ? 'board__sort-item--active' : ''}">
              <input id="sort-price" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" data-sort-type="${SortType.PRICE}" value="sort-price" checked>
